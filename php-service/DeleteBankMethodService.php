...
class DeleteBankMethodService {
    ...
    public function deleteBankMethod($token, $data) {
        $this->logger->log("Starting delete bank method process");
        ...
        if($stmt = mysqli_prepare($this->link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                return json_encode(["status" => "success", "message" => "Bank method deleted successfully"]);
            } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $service = new DeleteBankMethodService($link);
    echo $service->deleteBankMethod($jwt, $data);
}
?>